...
class UploadCompetitionForm extends StatefulWidget {
  @override
  _UploadCompetitionFormState createState() => _UploadCompetitionFormState();
}

class _UploadCompetitionFormState extends State<UploadCompetitionForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
        title: Text("Competition Form Page"),
      ),
      body: Container(
          ...
          child: ListView(
            children: <Widget>[
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value.isEmpty) {
                    return "Competition Name Field Empty";
                  }
                  return null;
                },
              ),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        ...
                        BorderRadius.all(Radius.circular(10.0))),
                    labelText: "Reward",
                    hintText: "Enter the Reward here"),
                validator: (value) {
                  if (value.isEmpty) {
                    return "Reward Field Empty";
                  }
                  return null;
                },
              ),
