            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  ...
                  Switch(
                    value: workshopIsSwitched,
                    onChanged: (value){
                      setState(() {
                        workshopIsSwitched=value;
                      });
                    },
                  ),
                ],
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        borderRadius:
                        BorderRadius.all(Radius.circular(10.0))),
                    labelText: workshopIsSwitched?"Rewards":"Choreographer",
                    hintText: "Enter details here"),
                validator: (value) {
                  if (value.isEmpty) {
                    return "Details Field Empty";
                  }
                  return null;
                },
              ),
